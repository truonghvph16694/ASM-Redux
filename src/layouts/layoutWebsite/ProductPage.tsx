        ...
        <div>
            <div className="grid grid-cols-1 lg:grid-cols-4 sm:grid-cols-3 text-center mx-6 sm:mx-48 gap-x-10 gap-y-5 my-10">
                {products.map((product: any) => (
                    ...
                    <div className="card bg-white rounded-lg max-w-sm dark:bg-gray-800 dark:border-gray-700 " key={product.id} >
                        <Link to={`detail/${product.id}`}>
                            <a href="#">
                                <img className="rounded-t-lg p-8 w-96 h-72" src={product.image} alt="product image" />
                            </a>
