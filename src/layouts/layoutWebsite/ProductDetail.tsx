...
const ProductDetail = () => {
    ...
    return (
        <div>
            <section className="text-gray-700 body-font overflow-hidden bg-white pl-32">
                <div className="container px-5 py-24 mx-auto">
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                        <img alt="ecommerce" className="w-72 object-cover object-center rounded border border-gray-200" src={products?.image} />
                        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            {/* <h2 className="text-sm title-font text-gray-500 tracking-widest">{products?.name}</h2> */}
                            ...
                            <div className="flex mb-4">
                                <span className="flex items-center">
                                    ...
                                    <span className="text-gray-600 ml-3">Số Lượng:{products?.quantity} SP</span>
                                </span>
                            ...
                            <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-200 mb-5">
                                ...
                                <div className="flex ml-6 items-center">
                                    ...
                                    <div className="flex pl-8">
                                        ...
                                        <input id="counter" aria-label="input" className="border border-gray-300 h-full text-center w-14 pb-1" type="text" placeholder="1" />
